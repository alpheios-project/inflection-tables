...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return languages; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return LanguageDataset; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return MatchData; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__source_selection_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__feature_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__feature_type_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__feature_list_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__feature_importer_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__language_model_factory_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__homonym_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__lexeme_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__lemma_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__inflection_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__latin_language_model_js__ = __webpack_require__(6);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__feature_list_js__["a"]; });
/* unused harmony reexport FeatureImporter */
/* unused harmony reexport Inflection */
...
/* unused harmony reexport Lexeme */
/* unused harmony reexport Lemma */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__language_model_js__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_styles__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_lang_latin_latin__ = __webpack_require__(12);
...
class Cell {
    ...
    render() {
        ...
        element.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].cell);
        for (let [index, suffix] of this.suffixes.entries()) {
            // Render each suffix
            let suffixElement = document.createElement('a');
            suffixElement.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].suffix);
            if (suffix.match && suffix.match.suffixMatch) {
                suffixElement.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].suffixMatch);
            }
            if (suffix.match && suffix.match.fullMatch) {
                suffixElement.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].suffixFullFeatureMatch);
            }
     ...
     */
    hide() {
        if (!this.wNode.classList.contains(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden)) {
            this.wNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
            this.nNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
        }
    }
    ...
    show() {
        if (this.wNode.classList.contains(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden)) {
            this.wNode.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
            this.nNode.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
        }
    }
     ...
     */
    highlight() {
        if (!this.wNode.classList.contains(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight)) {
            this.wNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight);
            this.nNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight);
        }
    }
    ...
    clearHighlighting() {
        if (this.wNode.classList.contains(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight)) {
            this.wNode.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight);
            this.nNode.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight);
        }
    }
...
class RowTitleCell {
    ...
    render() {
        ...
        this.wNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].cell);
        if (this.feature.formsColumn) {
            this.wNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].header);
        }
        if (this.feature.hasFullWidthRowTitle) {
            // This cell is taking an entire row
            this.wNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].fullWidth);
        }
        if (this.feature.formsColumn && this.feature.groupFeatureList.titleColumnsQuantity > 1) {
            this.wNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].widthPrefix + this.feature.groupFeatureList.titleColumnsQuantity);
        }
    ...
    static placeholder(width = 1) {
        ...
        placeholder.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].cell, __WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].widthPrefix + width);
        return placeholder;
    }
    ...
    highlight() {
        ...
        for (let nNode of this.nNodes) {
            nNode.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight);
        }
    }
    ...
    clearHighlighting() {
        this.wNode.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight);
        for (let nNode of this.nNodes) {
            nNode.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].highlight);
        }
    }
}
...
class HeaderCell {
    ...
    render() {
        let element = document.createElement('div');
        element.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].cell, __WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].header, __WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].widthPrefix + this.span);
     ...
     */
    changeSpan(value) {
        let currentWidthClass = __WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].widthPrefix + this.span;
        this.span += value;
        let newWidthClass = __WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].widthPrefix + this.span;
 ...
 */
class GroupFeatureType extends __WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["c" /* FeatureType */] {
    ...
    getOrderedFeatures(ancestorFeatures) {
        return this.getOrderedValues(ancestorFeatures).map((value) => new __WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */](value, this.type, this.language));
    }
 ...
 */
class GroupFeatureList extends __WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["b" /* FeatureList */] {
...
class WideView {
    ...
    constructor(columns, rows, headers, titleColumnQty) {
        ...
        this.nodes.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].inflectionTable, __WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].wideView);
    }
    ...
    render() {
        ...
        this.nodes.style.gridTemplateColumns = 'repeat(' + (this.visibleColumnQty + this.titleColumnQty) + ', '
            + __WEBPACK_IMPORTED_MODULE_2__styles_styles__["e" /* wideView */].column.width + __WEBPACK_IMPORTED_MODULE_2__styles_styles__["e" /* wideView */].column.unit + ')';
...
class NarrowView {
    ...
    constructor(groupQty, columns, rows, headers, titleColumnQty) {
        ...
        this.nodes = document.createElement('div');
        this.nodes.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].narrowViewsContainer);
...
class NarrowViewGroup {
    ...
    constructor(index, headers, rows, titleColumnQty) {
        ...
        this.nodes = document.createElement('div');
        this.nodes.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].inflectionTable, __WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].narrowView);
    }
    ...
    render() {
        ...
        if (this.visibleColumnQty) {
            ...
            this.nodes.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
            this.nodes.style.gridTemplateColumns = 'repeat(' + (this.visibleColumnQty + this.titleColumnQty) + ', '
                + __WEBPACK_IMPORTED_MODULE_2__styles_styles__["c" /* narrowView */].column.width + __WEBPACK_IMPORTED_MODULE_2__styles_styles__["c" /* narrowView */].column.unit + ')';
            this.nodes.style.width = (this.visibleColumnQty + this.titleColumnQty) * __WEBPACK_IMPORTED_MODULE_2__styles_styles__["c" /* narrowView */].column.width
                + __WEBPACK_IMPORTED_MODULE_2__styles_styles__["c" /* narrowView */].column.unit;
        }
        else {
            // This group is hidden
            this.nodes.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
        }
    }
}
        ...
        for (const featureValue of group.groupFeatureType.getOrderedFeatures(ancestorFeatures)) {
            ...
            if (currentLevel < this.features.length - 1) {
                ...
                if (selectedSuffixes.length > 0) {
                    ...
                    selectedSuffixes = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["d" /* Suffix */].combine(selectedSuffixes);
                }
...
class Footnotes {
    ...
    constructor(footnotes) {
        ...
        this.nodes.id = __WEBPACK_IMPORTED_MODULE_2__styles_styles__["b" /* footnotes */].id;
        this.nodes.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].footnotesContainer);
...
class View {
    ...
    display() {
        ...
        this.pageHeader.nodes.innerHTML = __WEBPACK_IMPORTED_MODULE_2__styles_styles__["d" /* pageHeader */].html;
        this.pageHeader.hideEmptyColumnsBtn = this.pageHeader.nodes.querySelector(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["d" /* pageHeader */].hideEmptyColumnsBtnSel);
        this.pageHeader.showEmptyColumnsBtn = this.pageHeader.nodes.querySelector(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["d" /* pageHeader */].showEmptyColumnsBtnSel);
        this.pageHeader.hideNoSuffixGroupsBtn = this.pageHeader.nodes.querySelector(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["d" /* pageHeader */].hideNoSuffixGroupsBtnSel);
        this.pageHeader.showNoSuffixGroupsBtn = this.pageHeader.nodes.querySelector(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["d" /* pageHeader */].showNoSuffixGroupsBtnSel);
    ...
    hideEmptyColumns() {
        ...
        this.display();
        this.pageHeader.hideEmptyColumnsBtn.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
        this.pageHeader.showEmptyColumnsBtn.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
    }
    ...
    showEmptyColumns() {
        ...
        this.display();
        this.pageHeader.showEmptyColumnsBtn.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
        this.pageHeader.hideEmptyColumnsBtn.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
    }
    ...
    hideNoSuffixGroups() {
        ...
        this.display();
        this.pageHeader.hideNoSuffixGroupsBtn.classList.add(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
        this.pageHeader.showNoSuffixGroupsBtn.classList.remove(__WEBPACK_IMPORTED_MODULE_2__styles_styles__["a" /* classNames */].hidden);
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__language_model_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__latin_language_model_js__ = __webpack_require__(6);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lemma_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__inflection_js__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_alpheios_data_models__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_noun_suffixes_csv__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_noun_footnotes_csv__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__data_adjective_suffixes_csv__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_adjective_footnotes_csv__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__data_verb_suffixes_csv__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__data_verb_footnotes_csv__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_papaparse__ = __webpack_require__(13);
...
let languageModel = new __WEBPACK_IMPORTED_MODULE_0_alpheios_data_models__["e" /* LatinLanguageModel */]();
let types = __WEBPACK_IMPORTED_MODULE_0_alpheios_data_models__["a" /* Feature */].types;
// A language of this module
const language = __WEBPACK_IMPORTED_MODULE_1__lib_js__["f" /* languages */].latin;
// Create a language data set that will keep all language-related information
let dataSet = new __WEBPACK_IMPORTED_MODULE_1__lib_js__["b" /* LanguageDataset */](language);
...
dataSet.matcher = function(inflections, suffix) {
     ...
     */
    for (let inflection of inflections) {
        let matchData = new __WEBPACK_IMPORTED_MODULE_1__lib_js__["c" /* MatchData */](); // Create a match profile
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__presenter_presenter__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_lib__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ui__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__templates_symbols_htmlf__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__templates_page_controls_htmlf__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__templates_panel_htmlf__ = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__templates_options_htmlf__ = __webpack_require__(53);
...
var ContentProcess = function () {
    function ContentProcess() {
        ...
        this.options = new __WEBPACK_IMPORTED_MODULE_4__ui__["a" /* Options */]();
        ...
        this.panel = new __WEBPACK_IMPORTED_MODULE_4__ui__["b" /* Panel */](this.options);
    ...
    _createClass(ContentProcess, [{
        ...
        value: function messageListener(message, sender) {
            ...
            } else if (message.type === __WEBPACK_IMPORTED_MODULE_3__lib_lib__["a" /* Message */].types.WORD_DATA_RESPONSE) {
                console.log('Message body is:', message.body);

                if (message.status === __WEBPACK_IMPORTED_MODULE_3__lib_lib__["a" /* Message */].statuses.DATA_FOUND) {
                    var wordData = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["e" /* WordData */].readObject(message.body);
                    console.log("Word data is: ", wordData);
                    this.panel.clear();
                    this.updateDefinition(wordData);
                    this.updateInflectionTable(wordData);
                    this.panel.open();
                } else if (message.status === __WEBPACK_IMPORTED_MODULE_3__lib_lib__["a" /* Message */].statuses.NO_DATA_FOUND) {
                    this.panel.clear();
        ...
        value: function updateInflectionTable(wordData) {
            this.presenter = new __WEBPACK_IMPORTED_MODULE_2__presenter_presenter__["a" /* default */](this.panel.inflTableContainer, this.panel.viewSelectorContainer, this.panel.localeSwitcherContainer, wordData).render();
        }
    }, {
        key: "renderOptions",
        ...
        value: function loadSymbols() {
            ContentProcess.loadHTMLFragment(__WEBPACK_IMPORTED_MODULE_5__templates_symbols_htmlf___default.a);
        }
    }, {
        key: "loadPageControls",
        value: function loadPageControls() {
            ContentProcess.loadHTMLFragment(__WEBPACK_IMPORTED_MODULE_6__templates_page_controls_htmlf___default.a);
        }
    }, {
        key: "loadPanel",
        value: function loadPanel() {
            ContentProcess.loadHTMLFragment(__WEBPACK_IMPORTED_MODULE_7__templates_panel_htmlf___default.a);
        }
    }, {
        ...
        value: function requestWordData(language, word) {
            browser.runtime.sendMessage(new __WEBPACK_IMPORTED_MODULE_3__lib_lib__["b" /* WordDataRequest */](language, word));
        }
    }, {
        key: "getSelectedText",
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__language_model_factory_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__language_model_js__ = __webpack_require__(2);
...
/* unused harmony default export */ var _unused_webpack_default_export = (FeatureImporter);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lexeme_js__ = __webpack_require__(8);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__l10n_l10n_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_view__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_latin__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_greek__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_alpheios_data_models__ = __webpack_require__(1);
/**
...
class Presenter {
    ...
    getViews(wordData) {
        ...
        for (let view of this.views) {
            if (wordData.language === view.language && wordData[__WEBPACK_IMPORTED_MODULE_5_alpheios_data_models__["a" /* Feature */].types.part].includes(view.partOfSpeech)) {
                views.push(view);
            }
        }
        return views;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__locale_en_us_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__locale_en_gb_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_intl_messageformat__ = __webpack_require__(23);
...
var src$core$$ = __webpack_require__(25), src$en$$ = __webpack_require__(30);
...
var src$utils$$ = __webpack_require__(11), src$es5$$ = __webpack_require__(26), src$compiler$$ = __webpack_require__(27), intl$messageformat$parser$$ = __webpack_require__(28);
...
exports = module.exports = __webpack_require__(29)['default'];
exports['default'] = exports;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_lang_latin_latin__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_view__ = __webpack_require__(4);





class LatinView extends __WEBPACK_IMPORTED_MODULE_3__lib_view__["c" /* View */] {
    constructor() {
        super();
        this.language = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["f" /* languages */].latin;
        this.language_features = __WEBPACK_IMPORTED_MODULE_2__lib_lang_latin_latin__["a" /* languageModel */].features;
         ...
         */
        this.features = {
            numbers: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], 'Number'),
            cases: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.grmCase], 'Case'),
            declensions: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.declension], 'Declension'),
            genders: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.gender], 'Gender'),
            types: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.type], 'Type')
        };
    }
     ...
     */
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["b" /* Table */]([this.features.declensions, this.features.genders,
            this.features.types, this.features.numbers, this.features.cases]);
        let features = this.table.features;
        features.columns = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.declension], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.gender], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.type]];
        features.rows = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.grmCase]];
        features.columnRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.grmCase]];
        features.fullWidthRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number]];
    }
}
...
class NounView extends LatinView {
    constructor() {
        ...
        this.partOfSpeech = this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.part].noun.value;

        // Models.Feature that are different from base class values
        this.features.genders = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.gender], 'Gender',
            [[this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.gender].masculine, this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.gender].feminine], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.gender].neuter]);
...
class AdjectiveView extends LatinView {
    constructor() {
        ...
        this.partOfSpeech = this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.part].adjective.value;

        // Models.Feature that are different from base class values
        this.features.declensions = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.declension], 'Declension',
            [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.declension].first, this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.declension].second, this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.declension].third]);
...
class VerbView extends LatinView {
    constructor() {
        super();
        this.partOfSpeech = this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.part].verb.value;

        this.features = {
            tenses: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense], 'Tenses'),
            numbers: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], 'Number'),
            persons: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person], 'Person'),
            voices: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.voice], 'Voice'),
            conjugations: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.conjugation], 'Conjugation Stem'),
            moods: new __WEBPACK_IMPORTED_MODULE_3__lib_view__["a" /* GroupFeatureType */](this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.mood], 'Mood')
        };
    }
}
...
class VoiceConjugationMoodView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["b" /* Table */]([this.features.voices, this.features.conjugations, this.features.moods,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.voice], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.conjugation], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.mood]];
        features.rows = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.columnRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.fullWidthRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense]];
    }
}
...
class VoiceMoodConjugationView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["b" /* Table */]([this.features.voices, this.features.moods, this.features.conjugations,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.voice], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.mood], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.conjugation]];
        features.rows = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.columnRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.fullWidthRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense]];
    }
...
class ConjugationVoiceMoodView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["b" /* Table */]([this.features.conjugations, this.features.voices, this.features.moods,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.conjugation], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.voice], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.mood]];
        features.rows = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number],this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.columnRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.fullWidthRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense]];
    }
...
class ConjugationMoodVoiceView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["b" /* Table */]([this.features.conjugations, this.features.moods, this.features.voices,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.conjugation], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.mood], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.voice]];
        features.rows = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.columnRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.fullWidthRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense]];
    }
...
class MoodVoiceConjugationView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["b" /* Table */]([this.features.moods, this.features.voices, this.features.conjugations,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.mood], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.voice], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.conjugation]];
        features.rows = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.columnRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.fullWidthRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense]];
    }
...
class MoodConjugationVoiceView extends VerbView {
    ...
    createTable() {
        this.table = new __WEBPACK_IMPORTED_MODULE_3__lib_view__["b" /* Table */]([this.features.moods, this.features.conjugations, this.features.voices,
            this.features.tenses, this.features.numbers, this.features.persons]);
        let features = this.table.features;
        features.columns = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.mood], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.conjugation], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.voice]];
        features.rows = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.columnRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.number], this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.person]];
        features.fullWidthRowTitles = [this.language_features[__WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__["a" /* Feature */].types.tense]];
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_lang_greek_greek__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_view__ = __webpack_require__(4);
...
class GreekView extends __WEBPACK_IMPORTED_MODULE_2__lib_view__["c" /* View */] {
    constructor() {
        super();
        this.language = __WEBPACK_IMPORTED_MODULE_0__lib_lib__["f" /* languages */].greek;
...
class NounViewSimplified extends NounView {
    ...
    static suffixCellFilter(suffix) {
        return suffix.extendedLangData[__WEBPACK_IMPORTED_MODULE_0__lib_lib__["f" /* languages */].greek].primary;
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_alpheios_data_models__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_noun_suffixes_csv__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_noun_suffixes_csv___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__data_noun_suffixes_csv__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_noun_footnotes_csv__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_noun_footnotes_csv___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__data_noun_footnotes_csv__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_papaparse__ = __webpack_require__(13);
...
// A language of this module
const language = __WEBPACK_IMPORTED_MODULE_0__lib_js__["f" /* languages */].greek;
// Create a language data set that will keep all language-related information
let dataSet = new __WEBPACK_IMPORTED_MODULE_0__lib_js__["b" /* LanguageDataset */](language);
...
dataSet.addSuffixes = function(partOfSpeech, data) {
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        let extendedLangData = {
            [__WEBPACK_IMPORTED_MODULE_0__lib_js__["f" /* languages */].greek]: extendedGreekData
        };
...
dataSet.matcher = function(inflections, suffix) {
     ...
     */
    for (let inflection of inflections) {
        let matchData = new __WEBPACK_IMPORTED_MODULE_0__lib_js__["c" /* MatchData */](); // Create a match profile
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uuid_v1__ = __webpack_require__(45);
