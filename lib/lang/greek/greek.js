...
import GreekInflectionProperties from './greek-inflection-properties.js'
...
// For pronouns
dataSet.pronounGroupingLemmas = new Map([
...
dataSet.getInflectionProperties = function (partOfSpeech) {
  return new GreekInflectionProperties(partOfSpeech)
}

dataSet.getPronounGroupingLemmas = function (grammarClass) {
...
dataSet.getGrammarClass = function (word) {
  ...
  let classValue = (matchingForm && matchingForm.features[Feature.types.grmClass])
    ...
    : ''
  return [languageModel.features[Feature.types.grmClass].get(classValue)]
}
