...
export default class LanguageDataset {
  ...
  setInflectionData (inflection, lemma) {
    ...
    if (inflection.constraints.implemented) {
      ...
      GreekParadigmDataset.setParadigmInflectionData(this.pos, inflection, lemma)
      console.info('inflection.constraints 0- ', inflection.constraints)
      ...
      if (inflection.constraints.fullFormBased || !(inflection.constraints.suffixBased || inflection.constraints.paradigmBased)) {
        ...
        console.info('hasMatchingForms - ', hasMatchingForms)
        if (hasMatchingForms) {
      ...
      console.info('inflection.constraints 1- ', inflection.constraints)
      ...
      console.info('inflection.constraints 2- ', inflection.constraints)
    }

    console.info('setInflectionData', inflection.constraints.paradigmBased)
    return inflection
  }
