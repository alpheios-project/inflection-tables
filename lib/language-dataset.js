...
export default class LanguageDataset {
  ...
  addInflectionData (partOfSpeech, ClassType, itemValue, features, footnotes = [], extendedLangData = undefined) {
    // console.info('LanguageDataset addInflectionData')
  ...
  setInflectionData (inflection, lemma) {
    ...
    // console.info('LanguageDataset setInflectionData', inflection)
  ...
  createInflectionSet (pofsValue, inflections, options) {
    ...
    // console.info('LD createInflectionSet - ', inflections.length)
    ...
    // console.info('LanguageDataset createInflectionSet start', inflectionSet.isImplemented)
    ...
    if (inflectionSet.isImplemented) {
      ...
      */
      ...
      // console.info('LanguageDataset createInflectionSet implemented', inflectionSet)
    }
